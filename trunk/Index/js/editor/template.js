(function(CF,$){
	...
	$.push({
		...
		initModule : function(){
			...
			this.app.addEventListener('saveAsTemplate',function(config){
				this.Template.saveAsTemplate(config);
			});
