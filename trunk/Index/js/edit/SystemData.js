...
systemTemplate=[{
	...
	type : 'float-line',
	html : ['<div class="float-line h"><div class="bg"></div></div> '].join('')
},{
	type : 'float-image',
	...
	html : ['<div class="layout property-itable col1 w6" style="height:400px;">',
			  '<div class="p-r pp-i-image-box">',
				'<div class="property-image img-b img-p"><img src="/s.gif"/></div>',
			  '</div>',
...
fixedGridTemplate = {
	...
	'2' : [
			...
			'<div class="layout image-fgrid" style="height:300px;"><div class="p-r" style="width:60%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"></div></div><div class="p-n" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"></div></div></div>',
			'<div class="layout image-fgrid" style="height:300px;"><div class="p-r" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"></div></div><div class="p-n" style="width:60%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"></div></div></div>',
	...
	'3' : [
			...
			'<div class="layout image-fgrid" style="height:260px;"><div class="p-r" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-n" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:300px;"><div style="width:30%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:30%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:40%;height:100%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:300px;"><div style="width:35%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:35%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:30%;height:100%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>'
		  ],
	'4' : [
			...
			'<div class="layout image-fgrid" style="height:260px;"><div style="width:40%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:100%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:260px;"><div class="p-r" style="width:20%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-n" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:400px;"><div style="width:30%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:45%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:25%;height:50%;" class="p-b"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:25%;height:50%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:400px;"><div style="width:30%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:45%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:25%;height:40%;" class="p-b"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:25%;height:60%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>'
		  ],
	'5' : [
	...
	'7' : [
			'<div style="height:550px;" class="layout image-fgrid"><div class="p-r" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-n" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div style="height:550px;" class="layout image-fgrid"><div class="p-r-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-n f-r" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:50%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div class="layout image-fgrid" style="height:500px;"><div style="width:40%;height:100%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:60%;" class="p-r-b"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:60%;" class="p-r-b"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:60%;" class="p-b"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:40%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:40%;" class="p-r"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div style="width:20%;height:40%;" class="p-n"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>',
			'<div style="height:500px;" class="layout image-fgrid"><div class="p-r-b" style="width:20%;height:60%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:60%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r-b" style="width:20%;height:60%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-n f-r" style="width:40%;height:100%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:40%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:40%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div><div class="p-r" style="width:20%;height:40%;"><div class="image-flink img-b img-p"><img src="/s.gif"/></div></div></div>'
		]
};
