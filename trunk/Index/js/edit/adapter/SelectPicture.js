						...
						html : ['<div class="idex-picture-tree"></div>',
								'<div class="idex-picture-list">',
									'<div class="idex-picture-item">',
										'<img src="http://img04.taobaocdn.com/bao/uploaded/i4/TB1wVEnGFXXXXcJXXXXXXXXXXXX_!!0-item_pic.jpg_200x200.jpg"/>',
										'<div class="item-title">选择</div>',
									'</div>',
									'<div class="idex-picture-item">',
										'<img src="http://img02.taobaocdn.com/bao/uploaded/i2/TB1VkHSGFXXXXbNXFXXXXXXXXXX_!!0-item_pic.jpg_200x200.jpg"/>',
										'<div class="item-title">选择</div>',
									'</div>',
									'<div class="idex-picture-item">',
									...
									'</div>',
									'<div class="idex-picture-item">',
										'<img src="http://img01.taobaocdn.com/bao/uploaded/i1/TB1Mg2WGFXXXXbLXXXXXXXXXXXX_!!0-item_pic.jpg_200x200.jpg"/>',
										'<div class="item-title">选择</div>',
									'</div>',
									'<div class="idex-picture-item">',
										'<img src="http://img04.taobaocdn.com/bao/uploaded/i4/TB1fc9CGFXXXXbVXpXXXXXXXXXX_!!0-item_pic.jpg_200x200.jpg"/>',
										'<div class="item-title">选择</div>',
									'</div>',
									'<div class="idex-picture-item">',
										'<img src="http://img04.taobaocdn.com/bao/uploaded/i4/TB1wVEnGFXXXXcJXXXXXXXXXXXX_!!0-item_pic.jpg_200x200.jpg"/>',
