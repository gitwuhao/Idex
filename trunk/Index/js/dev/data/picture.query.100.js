...
for(;i<count;i++){
	result.push({title:"idex_1_101010744_"+(i+1),pixel:"800x1200",path:"http://img01.taobaocdn.com/imgextra/i1/1646439371/TB2i1hDaXXXXXcvXXXXXXXXXXXX-1646439371.gif"});
}
