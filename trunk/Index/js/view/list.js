			...
			html :[
				    ...
				    '<div class="idex-list-box">',
						...
						'<div class="idex-paging-box">',
							'<div class="x-ui-button"><div class="x-ui-label">上一页</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">1</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">2</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">3</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">4</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">5</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">6</div></div>',
							'<div class="x-ui-button"><div class="x-ui-label">下一页</div></div>',
						'</div>',
					'</div>',
				  ].join(''),
			_form_ : {
